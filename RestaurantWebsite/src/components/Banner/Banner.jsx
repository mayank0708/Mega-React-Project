  ...
  return (
    ...
    <div className="container py-14 relative">
        <div className=' relative z-20'>
            ...
            font-semobild text-dark text-center'>
                ...
                sm:grid-cols-2 gap-4 py-10'>
                    <div>
                        <p>
                            ...
                            time</span> is the greatest value in 
                            the modern world.
                            Our healthy meal plan delivery service Good
                            Food in Miami is the answer for those who want to eat 
                            healthy, saving time for buying food and preparing delicious,
                            healthy meals.
                        </p>
                    </div>
                    <div></div>
        ...
        className='absolute top-5 -left-16 sm:bottom-0 sm:left-0 
